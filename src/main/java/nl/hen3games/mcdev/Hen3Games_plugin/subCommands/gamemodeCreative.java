            ...
            if (player.hasPermission(Permissions.Gamemode)) {
                if (args[0].equals("1")){
                    if (args.length == 1){
                        ...
                        player.sendMessage(ChatColor.GREEN + "Je Gamemode is veranderd naar creative");
                        ...
                        if (tagplayer == null){
                            ...
                            tagplayer.setGameMode(GameMode.CREATIVE);
                            player.sendMessage(ChatColor.GREEN + "Je hebt de Gamemode van: " + tagplayer + " veranderd naar Gamemode creative");
                        }
                    }
                }
            }
