            ...
            if (player.hasPermission(Permissions.Gamemode)) {
                if (args[0].equals("0")){
                    if (args.length == 1){
                        ...
                        player.sendMessage(ChatColor.GREEN + "Je Gamemode is veranderd naar survival");
                        ...
                        if (tagplayer == null){
                            ...
                            tagplayer.setGameMode(GameMode.SURVIVAL);
                            player.sendMessage(ChatColor.GREEN + "Je hebt de Gamemode van: " + tagplayer + " veranderd naar Gamemode survival");
                        }
                    }
                }
            }
