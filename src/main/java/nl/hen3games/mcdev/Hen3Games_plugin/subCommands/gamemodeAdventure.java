            ...
            if (player.hasPermission(Permissions.Gamemode)) {
                if (args[0].equals("2")){
                    if (args.length == 1){
                        ...
                        player.sendMessage(ChatColor.GREEN + "Je Gamemode is veranderd naar adventure");
                        ...
                        if (tagplayer == null){
                            ...
                            player.sendMessage(ChatColor.GREEN + "Je hebt de Gamemode van: " + tagplayer + " veranderd naar Gamemode adventure");
                        }
                    }
                }
            }
